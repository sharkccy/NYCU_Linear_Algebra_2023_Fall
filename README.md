...
- See `2023_Linear_Algebra_Team4_Final_Project_Report.pdf` for a detailed explanation of the methodology and results.
- See `demo.mp4` for the visualization of the efficient frontier.
